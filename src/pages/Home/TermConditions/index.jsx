    ...
    return (
        <section>
            <div className='container text-center py-10'>
                ...
                <h2 className='font-semibold text-[18px] md:text-[20px] text-center max-w-[640px] mx-auto mt-3 md:mt-5 mb-3 '>1. Introduction</h2>
                <p className="text-center text-sm md:text-[16px] font-[400] leading-normal mx-auto max-w-full md:max-w-[955px] w-full">
                ...
                <h2 className='font-semibold text-[18px] md:text-[20px] text-center max-w-[640px] mx-auto mt-3 mb-3 '>
                    2. Use of Website
                </h2>
                <p className="text-center text-sm md:text-[16px] font-[400] leading-normal mx-auto max-w-full md:max-w-[955px] w-full">
