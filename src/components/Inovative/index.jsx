...
function Innovative() {
    ...
    return (
        <section ref={sectionRef} className="box fadeIn flex justify-center items-center flex-col px-3 md:px-5 py-20">
            ...
            <p className="text-center text-xl md:text-xl font-normal leading-normal mt-[30px] md:mt-[50px] max-w-full md:max-w-[855px] w-full">
            ...
            {hasAnimated && (
                <Player
                    ...
                    className='absolute right-[40px]  arrow-five'
                    keepLastFrame={true}
                />
            )}
        </section>
