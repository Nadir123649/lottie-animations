...
function Footer() {
    return (
        <footer className="relative pt-5 md:pt-10">
            <img src={MainImageFooter} alt="" className="relative top-[1px]" />
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-center px-5 pb-[20px] bg-black">
                <p className="text-white text-sm mb-0 pt-2 pb-2 md:pb-0 md:pt-5">
                    © Constantinou. 2024. All rights reserved
                </p>
                <img src={umbrella} alt="umbrella" className="max-w-[80px] " />
                <p className="text-white text-sm font-normal mb-0 pt-2 pb-2 md:pb-0 md:pt-5">
