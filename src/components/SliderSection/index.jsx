...
const SliderSection = () => {
    ...
    return (
        <section ref={sectionRef} className='pt-[40px] md:py-10 md:pt-5 relative'>
                    ...
                    {companiesdata.map((company) => (
                        <div key={company.id} className='slide flex justify-center items-center py-2 logo-slide'>
                            <img
                                src={company.logo}
                                alt={`Logo ${company.id}`}
                                className='w-[180px] h-[50px] min-h-[50px] md:w-[234px] md:h-[60px] md:min-h-[60px] mx-auto block object-contain'
                            />
                        </div>
                    ))}
                </Slider>
